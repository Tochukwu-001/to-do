...
//       //add this doccument to the database
...
//   return (
//     <main className='h-[100rem] bg-blue-100'>
//       <Formik
...
//             <button
//               type='submit'
//               className='p-3 rounded-md bg-white text-blue-500 text-2xl  flex'
//             >
//               <FaPlus />
//             </button>
//           </div>
...
//           {
//             todos.map((todo) => (
//               <li key={todo.id} className= {`w-[90%] mx-auto flex justify-between p-3 text-lg border-b border-b-gray-400 rounded-lg ${todo.completed ? 'line-through bg-gray-200' : ''}`}>
//                 <input
...
//                   <FaTrashAlt className='hover:text-red-500 hover:text-2xl transition-all' />
//                 </button>
//               </li>
//             ))
//           }
//         </ul>
//       </div>
//       <p className='text-center text-sm p-10 text-blue-500 '>You have {todos.length} tasks</p>
//     </main>
//   )
// }
    ...
    <main className='h-dvh bg-blue-50 overflow-y-scroll'>
      ...
      <div>
        <ul className='w-full'>
          {
            todos.map((todo) => (
              <li key={todo.id} className={`w-[90%] mx-auto flex justify-between p-3 m-3 text-lg border-b border-b-gray-300 rounded-lg ${todo.completed ? 'line-through bg-gray-200 text-gray-500' : ''} `}>
                <input
                  onChange={() => check(todo.id, todo.completed)}
                  checked={todo.completed}
                  type="checkbox" />
